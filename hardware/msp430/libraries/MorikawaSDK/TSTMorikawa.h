...
#define UNPROGMEM // until this is resolved

#ifndef __TST_MORIKAWA_H
#define __TST_MORIKAWA_H

#include "TSTType.h"
#include "TSTTrinity.h" // don't know why this was missing, maybe it was included in
                       // one of the header file inclusions I commented out below
...
class TSTMorikawa {
    ...
    public:
        ...
        // static  TSTError            getCameraFormat             (CameraType mode, CameraFormat* result);
                ...
                // TSTError            setTextPGM                  (TextType index, char const UNPROGMEM* text, int length = -1);
        ...
        static  TSTError            writeEEPROMPGM              (unsigned long address, void const UNPROGMEM* data, unsigned int size, unsigned int* result = NULL);
        ...
        static  TSTError            formatEEPROM                (void);
                ...
                // TSTError            writeSharedMemoryPGM        (unsigned long address, void const UNPROGMEM* data, unsigned int size, unsigned int* result = NULL);
                ...
                TSTError            writeFRAMPGM                (unsigned long address, void const UNPROGMEM* data, unsigned int size, unsigned int* result = NULL);
                ...
                // TSTError            writeFlashROMPGM            (unsigned long address, void const UNPROGMEM* data, unsigned int size, unsigned int* result = NULL);
                ...
                // TSTError            playFrequencyPGM            (FrequencySequence const UNPROGMEM* sequence, int length = -1);
                ...
                // TSTError            playNotePGM                 (NoteSequence const UNPROGMEM* sequence, int length = -1);
                // TSTError            playMorse                   (NoteType note, char character);
                // TSTError            playMorse                   (NoteType note, char const* sequence, int length = -1);
                // TSTError            playMorsePGM                (NoteType note, char const UNPROGMEM* sequence, int length = -1);
                // TSTError            speakPhrase                 (char const* phrase, int length = -1);
                // TSTError            speakPhrasePGM              (char const UNPROGMEM* phrase, int length = -1);
    ...
    private:
        ...
        static  void                writeSelfTestLog            (unsigned int address, void const* data, unsigned int size);
                ...
                TSTError            checkTelemetryTime          (TimeType type, void* result, RuleRec const UNPROGMEM** rule) const;
                TSTError            checkTelemetryVoltage       (VoltageType type, void* result, RuleRec const UNPROGMEM** rule) const;
                TSTError            checkTelemetryCurrent       (CurrentType type, void* result, RuleRec const UNPROGMEM** rule) const;
                TSTError            checkTelemetryTemperature   (TemperatureType type, void* result, RuleRec const UNPROGMEM** rule) const;
                TSTError            checkTelemetryGyro          (GyroType type, void* result, RuleRec const UNPROGMEM** rule) const;
                TSTError            checkTelemetryMagnet        (MagnetType type, void* result, RuleRec const UNPROGMEM** rule) const;
                void                convertTelemetry            (RuleRec const UNPROGMEM* rule, bool convert, void* result) const;
        ...
        static  TSTError            sendRequest                 (char to, char const UNPROGMEM* command);
        static  TSTError            sendResponse                (char to, char const UNPROGMEM* command);
        static  TSTError            sendPacket                  (char mode, char to, char const UNPROGMEM* command);
...
#if 0
/*public */inline TSTError TSTMorikawa::setTextPGM(TextType index, char const UNPROGMEM* text, int length)
{
...
/*public */inline TSTError TSTMorikawa::writeSharedMemory(unsigned long address, void const* data, unsigned int size, unsigned int* result)
{
    ...
    return TSTERROR_NO_MEMORY;
}

#if 0
/*public */inline TSTError TSTMorikawa::writeSharedMemoryPGM(unsigned long address, void const UNPROGMEM* data, unsigned int size, unsigned int* result)
{
...
#if 0
/*public */inline TSTError TSTMorikawa::writeFRAMPGM(unsigned long address, void const UNPROGMEM* data, unsigned int size, unsigned int* result)
{
...
#if 0
/*public */inline TSTError TSTMorikawa::writeFlashROMPGM(unsigned long address, void const UNPROGMEM* data, unsigned int size, unsigned int* result)
{
...
#if 0
/*public */inline TSTError TSTMorikawa::playFrequencyPGM(FrequencySequence const UNPROGMEM* sequence, int length)
{
...
#if 0
/*public */inline TSTError TSTMorikawa::playNotePGM(NoteSequence const UNPROGMEM* sequence, int length)
{
...
#if 0
/*public */inline TSTError TSTMorikawa::playMorsePGM(NoteType note, char const UNPROGMEM* sequence, int length)
{
...
#if 0
/*public */inline TSTError TSTMorikawa::speakPhrasePGM(char const UNPROGMEM* phrase, int length)
{
